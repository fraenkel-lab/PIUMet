...
class PIUMetInput_class(MySQLConnect_class, object):
    ...
    # ---------------------------------------
    # this function handles mz terminals
    def mz_terminal_input(self, mzTerminal_all, superClass, ppm, mzW):
        ...
        if self.mzMet_net_union.nodes() == []:
            print "there is no Matched metabolites from the interactome to the m/z peaks; this can be caused by a very small ppm value"
    ...
    # --------------------------------------
    # this function converts HMDB-ID of input to Met id in the interactome
